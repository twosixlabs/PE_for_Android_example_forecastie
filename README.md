...
## PE Android Features
* User's location remains private from the forcastie application
   - Forcastie application only learns the zip code of the user's location
